    ...
    <div className="animate-in max-w-4xl">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-surface-500">Remplissez les détails de la facture</p>
        </div>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div className="card p-6">
          <h2 className="font-medium text-surface-900 mb-4">Lignes de facturation</h2>
          <div className="space-y-3">
            ...
            {items.map((item, i) => (
              <div key={i} className="grid grid-cols-12 gap-2 items-center">
                ...
                <div className="col-span-2 text-sm font-medium text-surface-700 text-right px-2">
                  {fmt(subtotalItem(item) + taxItem(item))}
                </div>
                <div className="col-span-1 flex justify-end">
                  {items.length > 1 && (
                    <button onClick={() => removeItem(i)} className="p-1.5 text-surface-400 hover:text-red-500 rounded-lg hover:bg-red-50">
            ...
            <button onClick={() => setItems(p => [...p, defaultItem()])}
              className="btn-ghost text-brand-600 text-sm mt-1">
